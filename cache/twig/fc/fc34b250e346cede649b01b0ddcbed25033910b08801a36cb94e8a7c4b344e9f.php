...
/* docs.html.twig */
class __TwigTemplate_9f66563388f1edcd02147423fe0561f01c932a4c8d717da80266cdff98aeb8e1 extends Twig_Template
{
...
\t";
        ...
        if ( !$this->getAttribute((isset($context["progress"]) ? $context["progress"] : null), "isFirst", array(0 => $this->getAttribute((isset($context["page"]) ? $context["page"] : null), "path", array())), "method")) {
            ...
            echo "\"> <i class=\"fa fa-caret-left\"></i></a>
\t";
        }
        // line 14
        echo "
...
/* 	    <a class="nav nav-prev" href="{{ progress.nextSibling(page.path).url }}"> <i class="fa fa-caret-left"></i></a>*/
/* 	{% endif %}*/
/* */
/* 	{% if not progress.isLast(page.path) %}*/
/* 	    <a class="nav nav-next" href="{{ progress.prevSibling(page.path).url }}"><i class="fa fa-caret-right"></i></a>*/
/* 	{% endif %}*/
/* 	</div>*/
/* {% endblock %}*/
/* */
